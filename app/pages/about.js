    ...
    <div className="min-h-screen my-6 py-16 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="lg:text-center">
          <h1 className="text-base text-blue-800 font-semibold tracking-wide uppercase justify-center text-center">à Propos</h1>
          <p className="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl text-center">
          VOUS SOUHAITEZ NOUS CONTACTER!
          </p>
          <p className="mt-4 max-w-2xl text-xl text-gray-700 lg:mx-auto text-center">
